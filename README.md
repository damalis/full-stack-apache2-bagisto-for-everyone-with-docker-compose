# [full stack apache2 Bagisto for everyone with docker compose](https://github.com/damalis/full-stack-apache2-bagisto-for-everyone-with-docker-compose)
...
```
git clone https://github.com/damalis/full-stack-apache2-bagisto-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-apache2-bagisto-for-everyone-with-docker-compose
chmod +x install.sh
